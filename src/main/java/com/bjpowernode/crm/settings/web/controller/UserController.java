...
public class UserController extends HttpServlet {
    ...
    private void login(HttpServletRequest request, HttpServletResponse response) {
        ...
        //获取 login.jsp中 ajax中的data的loginAct和loginPwd
        ...
        try {
            ...
            User user = us.login(loginAct,loginPwd,ip);//调login这个业务层的方法

            request.getSession().setAttribute("user",user);//把user对象保存到Session域中
            ...
            *           private String msg;
            *
            *      如果对于展现的信息将来还会大量的使用,创建Vo类,使用方便
            *      如果对于展现的信息只有在这个需求中能够使用,使用map就可以了
            */
