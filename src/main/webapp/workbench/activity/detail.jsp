	...
	$(function(){
				...
				success: function (data) {
					...
					* */
					...
					$.each(data,function (i,n) {
						...
						动态生成的元素不能使用id选择器,使用直接触发事件 onclick
						* */
		...
		function deleteRemark(id) {
			...
			$.ajax({
				...
				success: function (data) {
					<%--后台为前台返回的参数--%>
					/*一般来说,添加,修改,删除返回一个success就行了,表示删除成功还是失败*/
					/*
					* 	data
					* 		{"success":true/false}
					*
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<%--a.name,a.startDate...是ActivityController.java中的detail()方法里的a。转发出来才可以直接使用以下代码格式--%>
	...
	<div style="position: relative; top: -70px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 40px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${a.editBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${editTime}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
